...
class TaskHolder(
    ...
    var arg1: TableDto?,
    var arg2: TableDto?,
    @Transient val arg1Future: CompletableFuture<TableDto>? = null,
    @Transient val arg2Future: CompletableFuture<TableDto>? = null,
    // where to send the result of task
    @Transient val resultTo: CompletableFuture<TableDto>? = null
)
